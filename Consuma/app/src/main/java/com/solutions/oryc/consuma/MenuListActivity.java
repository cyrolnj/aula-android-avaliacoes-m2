...
public class MenuListActivity extends AppCompatActivity {
    ...
    public void onClickDeleteMenu(View view) {
        ...
        int itemPosition = 0; //Pega o ID do item clicado;


        ProductMenu productMenu = productMenuList.get(itemPosition);
        ProductMenuDao.deleteProductMenu(productMenu);
        //Toast.makeText(this, productMenu.getId(), Toast.LENGTH_SHORT).show();
